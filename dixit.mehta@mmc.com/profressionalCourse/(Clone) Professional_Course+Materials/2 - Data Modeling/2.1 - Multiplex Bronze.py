...
def process_bronze():
    ...
    query = (spark.readStream
                  ...
                  .writeStream
                      .option("checkpointLocation", "dbfs:/mnt/demo_pro/checkpoints/dixit/bronze")
...
batch_df = spark.table("dixit.bronze")
display(batch_df)

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM dixit.bronze
...
# MAGIC %sql
# MAGIC SELECT COUNT(*) FROM dixit.bronze
